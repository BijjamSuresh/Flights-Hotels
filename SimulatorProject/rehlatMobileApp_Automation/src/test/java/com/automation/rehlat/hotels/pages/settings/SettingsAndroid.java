package com.automation.rehlat.hotels.pages.settings;
...
import static com.automation.rehlat.hotels.pages.hotels.HotelsAndroid.DOMAIN_LIST_VIEW;
...
public class SettingsAndroid extends SettingsBase {
    ...
    public static final String SELECTED_COUNTRY_NAME = "com.app.rehlat:id/country_name";
    public static final String SELECT_COUNTRY_LAYOUT = "com.app.rehlat:id/country_llyt";
...
//            }else{
            HotelsAndroid.selectCountryOfUser(parsingDomainName);
...
//            }
    ...
    public void selectTheCurrencyName(String parsingCurrencyName) {
        ...
        try {
            if (isElementDisplayedById(CURRENCY_LIST_VIEW)) {
                ...
                List<WebElement> displayedCountriesList = displayedCurrenciesListView.findElements(By.className(Labels_Hotels.ANDROID_TEXT_VIEW));
    ...
    public String getTheCurrentDomain() {
        ...
        try {
            String currentDomain = driver.findElementById(SELECTED_COUNTRY_NAME).getText();
