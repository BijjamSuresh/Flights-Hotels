...
public class OneWayBooking_InternationalTicket_WithAppliedCouponCode_And_WithSignUp_FromBookingsPageScreen extends BaseTest {
    ...
    public void testTicketBookingWithAppliedCouponCodeAndWithSignUpFromBookingsPageScreen() throws Exception{
        Logger.beginTest("OneWay_International_Ticket booking with applied coupon code and with sign up from booking page screen");
        ...
        if (PaymentOptionsScreen.isTicketSoldOutPopUpIsDisplayed()){
            ...
            ReviewBookingScreen.tapOnContinueButton();
            BookingPageScreen.checkBookingPageScreenIsDisplayed();
//            BookingPageScreen.tapOnSignInForFasterBookingsButton();  // This line of code is not necessary as user is already signed in or signed up before sold out alert
//            SignInScreen.checkSignInScreenIsDisplayed();
//            SignInScreen.tapOnCreateAccountButton();
//            SignUpScreen.checkSignUpScreenIsDisplayed();
//            SignUpScreen.enterSignUpCredentials();
...
//            BookingPageScreen.checkBookingPageScreenIsDisplayed();
        ...
        Logger.endTest(" - Ticket booking with applied coupon code and with sign up from booking page screen");
