...
import static com.automation.rehlat.flights.libCommon.General.*;
...
public class Base {
    ...
    public static void setUp() throws Exception {
        ...
        if (Labels_Flights.platform.equals(Labels_Flights.IOS)) {
            ...
            capabilities.setCapability("appium-version", Labels_Flights.IOS_CAPABILITIES_APPIUM_VERSION);
            capabilities.setCapability("deviceName", Labels_Flights.IOS_CAPABILITIES_DEVICE_NAME);
            capabilities.setCapability("platformName", Labels_Flights.IOS);
            capabilities.setCapability("platformVersion", Labels_Flights.IOS_CAPABILITIES_PLATFORM_VERSION_IPHONE7PLUS);
            capabilities.setCapability("udid", Labels_Flights.udid);
            capabilities.setCapability("app", Labels_Flights.IOS_BUNDLE_ID);
            capabilities.setCapability("waitForAppScript", true);
            capabilities.setCapability("autoGrantPermissions",true );
//            capabilities.setCapability("autoAcceptAlerts", true);
            capabilities.setCapability("showXcodeLog", true);
            app = new File(Labels_Flights.IOS_CAPABILITIES_APP_PATH);
            ...
            capabilities.setCapability("waitForAppScript", "true");
            driver = new IOSDriver(new URL(Labels_Flights.IOS_CAPABILITIES_URL), capabilities);
...
//            capabilities.setCapability("autoAcceptAlerts", true);
        ...
        driverWait = new WebDriverWait(driver, Labels_Flights.DEFAULT_WAITING_TIME);
    }
...
//            String pathOfScreenshot = "Screenshots/PixelEmulator/"+ nameOfTestCase + "_" + getPlatform();
    ...
    public static String getTestCaseName() {
        return Labels_Flights.testCaseName;
    }
    ...
    public static String getPlatform() {
        return Labels_Flights.platform;
    }
    ...
    public static void setTestCaseName(String name) {
        Labels_Flights.testCaseName = name;
    }
    ...
    public static boolean elementExists(String elementLocator, int seconds) {
        long timeToWait = (seconds == 0) ? 1 : (seconds * Labels_Flights.TAP_DURATION_MIN);
        boolean found;
        try {
        ...
        driverWait.withTimeout(Labels_Flights.WAIT_TIME_DEFAULT, TimeUnit.SECONDS);
        return found;
    }
    ...
    public static String getOsVersionIosOnly() {
        try{
            String commandArrayToListIosDevices[] = General.createArrayOfWordFromString(Labels_Flights.TERMINAL_COMMAND_LISTING_CONNECTED_IOS_DEVICES);
...
//                    Logger.logComment( xpath+" is enabled");
        ...
        while (counter < DEFAULT_SCROLL_ATTEMPTS)
        {
            try {
                ...
                if (getPlatform().equals(ANDROID_PLATFORM)) {
                    ...
                    if (up) {
                        swipeOnElementByClassName("XCUIElementTypeWindow", Labels_Flights.SwipeDirection.DIRECTION_UP);
                    } else {
                        swipeOnElementByClassName("XCUIElementTypeWindow", Labels_Flights.SwipeDirection.DIRECTION_DOWN);
                    }
                }
     ...
     * @param direction
     */
    public static void swipeOnElementByClassName(String className, Labels_Flights.SwipeDirection direction) {
        try {
     ...
     * @param direction
     */
    public static void swipeOnElementByName(String elementName, Labels_Flights.SwipeDirection direction) {
        try {
     ...
     */
    public static void swipeOnElementBy(WebElement element, Labels_Flights.SwipeDirection direction, double marginRatio) {
     ...
     * @param direction
     */
    public static void swipeOnElement(WebElement element, Labels_Flights.SwipeDirection direction) {
...
//        scrollToAnElement(xPath,down);
    ...
    public static String getElementValueByXpath(String elementXpath) throws Exception {
        ...
        if(counter>= Labels_Flights.MIN_ATTEMPTS){
...
//            driver.tap(Labels_Hotels.DEFAULT_FINGER_FOR_TAP, arrayListOfStartingPointLocationXAndY[0], arrayListOfStartingPointLocationXAndY[1], Labels_Hotels.DEFAULT_TAP_DURATION);
    ...
    public static void tapOnElementBasedOnLocation(WebElement Element, final String Direction) {
        ...
        try {
            ...
            driver.tap(Labels_Flights.DEFAULT_FINGER_FOR_TAP, arrayListLocationXAndY[0], arrayListLocationXAndY[1], Labels_Flights.DEFAULT_TAP_DURATION);
        } catch (Exception e) {
            fail("Couldn't find element with name " + Element);
        }
    }
    ...
    public static String getElementValueByClass(String className) {
        String elementValue = null;
        try {
            elementValue = driver.findElement(By.className(className)).getAttribute(Labels_Flights.VALUE_ATTRIBUTE);
        } catch (Exception exceptionDetail) {
    ...
    public static String getElementValueByName(String name) {
        String elementValue = null;
        try {
            elementValue = driver.findElement(By.name(name)).getAttribute(Labels_Flights.VALUE_ATTRIBUTE);
        } catch (Exception exceptionDetail) {
            fail(exceptionDetail.toString());
        }
        return elementValue;
    ...
    public static String getElementValue(WebElement element) {
        String elementValue = null;
        try {
            elementValue = element.getAttribute(Labels_Flights.VALUE_ATTRIBUTE);
        } catch (Exception exceptionDetail) {
            fail(exceptionDetail.toString());
        }
        return elementValue;
...
//            } else {
                element = driver.findElementByXPath(xpath);
                elementVisibility = element.getAttribute(Labels_Flights.VISIBLE_ATTRIBUTE);
//            }
...
//                return status;
                ...
                try {
                    boolean status = driver.findElementByClassName(Labels_Flights.UIA_KEYBOARD).isDisplayed();
                    return status;
                } catch (Exception elementNotFound) {
...
//            return terminalOutput.contains("mInputShown=true");
            ...
            try {
                boolean status = driver.findElementByClassName(Labels_Flights.UIA_DATEPICKER).isDisplayed();
    ...
    public static String getAndroidDeviceId() {
        if (Labels_Flights.platform.equals("Android")) {
...
//                    element.clear();
    ...
    public static String findElementByXpathAndReturnItsAttributeValue(String elementName) throws Exception {
        ...
        while (counter < Labels_Flights.MIN_ATTEMPTS) {
            try {
                elementValue = driver.findElementByXPath(elementName).getAttribute(Labels_Flights.VALUE_ATTRIBUTE);
    ...
    public static HashMap<String, List> getConnectedIosDevice() throws Exception {
        String commandToListUSBConnectedDevices[] = General.createArrayOfWordFromString(Labels_Flights.TERMINAL_COMMAND_LIST_CONNECTED_USB_DEVICE);
    ...
    public static void runAppInBackground( int timeLimit){
        ...
        try {
            ...
            Logger.logError("Encountered error:- Unable to run the app in the background");
        }
    ...
    public static void checkAppInstallation(String platform) {
        if (platform.equals(Labels_Flights.ANDROID)){
            Logger.logWarning("Yet to implement this method in Android");
