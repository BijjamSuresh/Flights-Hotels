    ...
    public void enterUserEmailId() {
        ...
        try {
            if (isElementDisplayedById(EMAIL_TEXT_FIELD)){
                driver.findElement(By.id(EMAIL_TEXT_FIELD)).sendKeys(Labels_Hotels.EMAIL_ID_SIGN_UP);
                Logger.logComment(Labels_Hotels.EMAIL_ID_SIGN_UP+" - element name is parsed");
                closeTheKeyboard_Android();
            }else {
    ...
    public void enterUserPassword() {
        ...
        try {
            if (isElementDisplayedById(PASSWORD_TEXT_FIELD)){
                driver.findElement(By.id(PASSWORD_TEXT_FIELD)).sendKeys(Labels_Hotels.PASSWORD);
                Logger.logComment(Labels_Hotels.PASSWORD+" - element name is parsed");
                closeTheKeyboard_Android();
            }else {
    ...
    public void enterUserRepeatPassword() {
        ...
        try {
            if (isElementDisplayedById(REPEAT_PASSWORD_TEXT_FIELD)){
                driver.findElement(By.id(REPEAT_PASSWORD_TEXT_FIELD)).sendKeys(Labels_Hotels.REPEAT_PASSWORD);
                Logger.logComment(Labels_Hotels.REPEAT_PASSWORD+" - element name is parsed");
                closeTheKeyboard_Android();
            }else {
    ...
    public void selectDomain() {
        ...
        try {
            if (isElementDisplayedById(SELECT_DOMAIN_TEXT_FIELD)){
                driver.findElementById(SELECT_DOMAIN_TEXT_FIELD).click();
    ...
    public void enterReferralCode() {
        ...
        try {
            if (isElementDisplayedById(REFERRAL_CODE_TEXT_FIELD)){
                driver.findElement(By.id(REFERRAL_CODE_TEXT_FIELD)).sendKeys(Labels_Hotels.REFERRAL_CODE);
                Logger.logComment(Labels_Hotels.REFERRAL_CODE+" :- referral code is parsed");
                closeTheKeyboard_Android();
                Thread.sleep(2000);
            }else {
