package com.automation.rehlat.flights.pages.flightsSimilarOptionsSearchResults;
...
//                String nameInTheXpath = driver.findElementByXPath(XPATH_OF_COMBINATIONS_AVAILABLE_AT_SAME_PRICE_LABEL).getAttribute(Labels_Hotels.VALUE_ATTRIBUTE);
