...
public class TwoWayBooking_DomesticTicket_WithoutCouponCode_And_WithSignUp_FromBookingsPage extends BaseTest {
    ...
    public void testTicketBookingWithoutCouponCodeAndWithSignUpFromBookingsPage() throws Exception{
        Logger.beginTest("TwoWay_Domestic_Ticket booking without coupon code and with sign up from bookings page");
...
//            BookingPageScreen.checkBookingPageScreenIsDisplayed();
            ...
            if (platform.equalsIgnoreCase(Labels_Flights.IOS)){
                TravellerDetailsScreen.acceptAutoFillPopulateModalIfDisplayed(3);
            }else {
                TravellerDetailsScreen.EnterTravellersDetailsForPassengers(3); // This should be same as passengers count in flights tab
            }
            TravellerDetailsScreen.tapOnSaveButton();
