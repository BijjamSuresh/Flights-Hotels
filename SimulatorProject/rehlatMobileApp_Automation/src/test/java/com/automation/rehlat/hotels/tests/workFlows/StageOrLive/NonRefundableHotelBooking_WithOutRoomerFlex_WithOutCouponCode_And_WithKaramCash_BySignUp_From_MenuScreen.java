...
public class NonRefundableHotelBooking_WithOutRoomerFlex_WithOutCouponCode_And_WithKaramCash_BySignUp_From_MenuScreen extends BaseTest {
    @Test
...
//        PaymentOptionsScreen.checkTheCreditOrDebitCardBookingProcessIsSuccess();
        Logger.endTest("Ticket booking without coupon code and with karam cash by sign up from menu screen");
