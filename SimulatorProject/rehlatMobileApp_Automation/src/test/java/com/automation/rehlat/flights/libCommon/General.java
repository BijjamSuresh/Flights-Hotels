package com.automation.rehlat.flights.libCommon;
...
import static com.automation.rehlat.flights.Labels_Flights.IOS_BUNDLE_ID;
import static com.automation.rehlat.flights.Labels_Flights.platform;
        ...
        if (platform.equalsIgnoreCase(Labels_Flights.IOS)){
            ...
            try {
                if (isAppInstalled(ANDROID_CAPABILITIES_PACKAGE_NAME)){
                    Logger.logComment("App is installed, going to un-install the app");
                    driver.removeApp(Labels_Flights.ANDROID_CAPABILITIES_PACKAGE_NAME);
                    Logger.logComment("App is uninstalled");
                }else {
                    Logger.logComment("App is already uninstalled");
                }
