...
public class VerifyUserIsAbleToNavigateToPnrPageAfterTappingOnContinueButtonInBookingPageScreen_TWOWAY_TRIP extends BaseTest {
    @Test
    public void testVerifyUserIsAbleToNavigateToPnrPageAfterTappingOnContinueButtonInBookingPageScreen_TWOWAY_TRIP() throws Exception{
        ...
        FlightsScreen.selectReturnDate(RETURN_DATE_BOOKING_MONTH,RETURN_DAY);
        FlightsScreen.tapOnDoneButton();
        FlightsScreen.checkFlightsTabIsDisplayed();
