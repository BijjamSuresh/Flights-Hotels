package com.automation.rehlat.flights.tests.workflows.ConfigurationsTypes.Live;
...
public class TwoWayBooking_InternationalTicket_WithAppliedCouponCode_And_WithSignIn_FromBookingsPageScreen extends BaseTest {
    ...
    public void testTicketBookingWithAppliedCouponCodeAndWithSignInFromBookingsPageScreen() throws Exception{
        Logger.beginTest("TwoWay_International_Ticket Booking with sign in from booking page and with applied coupon code ");
        ...
        if (PaymentOptionsScreen.isTicketSoldOutPopUpIsDisplayed()){
            ...
            ReviewBookingScreen.tapOnContinueButton();
            BookingPageScreen.checkBookingPageScreenIsDisplayed();
//            BookingPageScreen.tapOnSignInForFasterBookingsButton(); // Todo:- This is not necessary as already logged in before sold out
//            SignInScreen.checkSignInScreenIsDisplayed();
//            SignInScreen.enterLoginCredentials();
//            SignInScreen.tapOnLoginButton();
//            BookingPageScreen.checkBookingPageScreenIsDisplayed();
...
//                PaymentOptionsScreen.checkTheCreditOrDebitCardBookingProcessIsSuccess();
        ...
        Logger.endTest("TwoWay_International_Ticket Booking with sign in from booking page and with applied coupon code ");
