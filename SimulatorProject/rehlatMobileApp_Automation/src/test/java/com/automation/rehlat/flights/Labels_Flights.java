...
//    public static final String ANDROID_CAPABILITIES_APP_PATH = "app/app_debug.apk";
    ...
    public static final String DEPARTURE_DATE_FOR_ANDROID = "JAN 2019";
    public static final String DEPARTURE_MONTH_IN_CALENDAR_VIEW = "Jan";
    public static final String JOURNEY_YEAR = "2019";
    public static final String MONTH_IN_TRAVELLERS_DEPARTURE_DATE_FOR_ANDROID ="January";
    public static final String RETURN_MONTH_FOR_IOS = "Jan 2019";
    public static final String RETURN_MONTH_FOR_ANDROID = "JAN 2019";
...
//    public static String lastName;
    ...
    public static void setCountryLanguageAndAirportFromAndToLabels() {
        ...
        if (Labels_Flights.platform.equals(Labels_Flights.IOS)){
            ...
            Labels_Flights.FROM_INTERNATIONAL_AIRPORT_NAME = KUWAIT_AIRPORT_NAME_FOR_IOS;
            Labels_Flights.FROM_INTERNATIONAL_AIRPORT_CODE = KUWAIT_AIRPORT_CODE;
            Labels_Flights.TO_INTERNATIONAL_AIRPORT_NAME = CAIRO_AIRPORT_NAME_FOR_IOS;
            Labels_Flights.TO_INTERNATIONAL_AIRPORT_CODE = CAIRO_AIRPORT_CODE;
            Labels_Flights.KUWAIT_LANGUAGE_COUNTRY_LABEL = KUWAIT_LANGUAGE_COUNTRY_LABEL_FOR_IOS;

            ///////////////// DOMESTIC AIRPORTS NAMES /////////////////////////
//            Labels_Hotels.FROM_DOMESTIC_AIRPORT_NAME = HYDERABAD_AIRPORT_NAME_FOR_IOS;
//            Labels_Hotels.FROM_DOMESTIC_AIRPORT_CODE = HYDERABAD_AIRPORT_CODE;
//            Labels_Hotels.TO_DOMESTIC_AIRPORT_NAME = BANGALORE_AIRPORT_NAME_FOR_IOS;
//            Labels_Hotels.TO_DOMESTIC_AIRPORT_CODE = BANGALORE_AIRPORT_CODE;
            ...
            ////////////////// INTERNATIONAL AIRPORTS NAMES ////////////////////
            Labels_Flights.FROM_INTERNATIONAL_AIRPORT_NAME = KUWAIT_AIRPORT_NAME_FOR_ANDROID;
            Labels_Flights.FROM_INTERNATIONAL_AIRPORT_CODE = KUWAIT_AIRPORT_CODE;
            Labels_Flights.TO_INTERNATIONAL_AIRPORT_NAME = CAIRO_AIRPORT_NAME_FOR_ANDROID;
            Labels_Flights.TO_INTERNATIONAL_AIRPORT_CODE = CAIRO_AIRPORT_CODE;
            Labels_Flights.KUWAIT_LANGUAGE_COUNTRY_LABEL = KUWAIT_LANGUAGE_COUNTRY_LABEL_FOR_ANDROID;

            ///////////////// DOMESTIC AIRPORTS NAMES /////////////////////////
//            Labels_Hotels.FROM_DOMESTIC_AIRPORT_NAME = HYDERABAD_AIRPORT_NAME_FOR_ANDROID;
//            Labels_Hotels.FROM_DOMESTIC_AIRPORT_CODE = HYDERABAD_AIRPORT_CODE;
//            Labels_Hotels.TO_DOMESTIC_AIRPORT_NAME = BANGALORE_AIRPORT_NAME_FOR_ANDROID;
//            Labels_Hotels.TO_DOMESTIC_AIRPORT_CODE = BANGALORE_AIRPORT_CODE;
